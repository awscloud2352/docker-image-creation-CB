...
st.set_page_config(page_title="Scoopen Financial Planning Calculator")

st.title("Scoopen Financial Planning Calculator-May-2026")

st.header("**Monthly Income-May-2026**")
